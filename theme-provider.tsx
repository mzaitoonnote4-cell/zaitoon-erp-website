...
const mobileFeatures = [
  {
    ...
    description: "ضمن الخطة المستقبلية لمتابعة المبيعات من الهاتف",
  },
  {
    icon: DollarSign,
    title: "تتبع الأرباح الفوري",
    description: "رؤى مبسطة لصاحب العمل عند إطلاق التطبيق",
  },
  {
    icon: Package,
    title: "تنبيهات المخزون",
    description: "تنبيهات مخزون مستقبلية على الهاتف",
  },
  {
    icon: BarChart3,
    title: "أداء الفروع",
    description: "متابعة فروع أسهل ضمن الخطة المستقبلية",
  },
  {
    icon: Users,
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex items-center gap-3 text-muted-foreground">
                ...
                <span className="text-sm">ضمن خطة التطوير المستقبلية</span>
              </div>
            </div>
          </div>
        </div>
