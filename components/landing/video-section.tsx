      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg md:text-xl max-w-3xl mx-auto leading-relaxed text-pretty">
            فيديو توضيحي قصير يشرح كيف يساعدك النظام على إدارة المبيعات، المخزون، الأرباح، الفواتير، والموظفين من مكان واحد.
          </p>
        </div>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground text-sm">
                      نعمل على إعداد فيديو احترافي يشرح جميع مميزات النظام
                    </p>
                  </div>
                </div>
